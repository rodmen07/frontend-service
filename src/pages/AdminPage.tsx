        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-3">
          <div className="relative">
            <input
              ...
              className="w-full rounded-xl border border-zinc-700 bg-zinc-800/60 px-4 py-2.5 pr-10 text-sm text-zinc-100 placeholder-zinc-500 outline-none focus:border-amber-500/60 focus:ring-1 focus:ring-amber-500/30"
            />
            <button
              type="button"
